<?php
/**
 * Klasa Parser dla pliku: Odrzucone_poaczenia_z_hostow_wewnetrznych_...html
 * Wyciąga informacje o połączeniach wychodzących odrzuconych przez reguły Firewall.
 */
            ...
            if (!empty($headers) && $cols->length >= count($headers)) {
                ...
                if ($sourceIp) {
                    ...
                    $data['scans'][] = [
                        ...
                        'event_info' => 'Firewall Drop',
                        'event_desc' => 'Połączenie lokalnego hosta zablokowane przez politykę bezpieczeństwa',
