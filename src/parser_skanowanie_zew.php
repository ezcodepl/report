 ...
 * Analizuje próby skanowania z hostów zewnętrznych.
 */
            ...
            if (!empty($headers) && $cols->length >= count($headers)) {
                ...
                if ($sourceIp) {
                    ...
                    $data['scans'][] = [
                        ...
                        'application' => $app ?: 'Skanowanie portów',
                        'source_country' => $sourceCountry,
                        'dest_country' => $destCountry,
                        'danger_level' => $eventsCount > 10000 ? 'Critical' : 'High',
                        'events_count' => $eventsCount,
                        'event_info' => 'External Scan detected',
                        'event_desc' => 'Wykryto złośliwe próby skanowania portów z adresu zewnętrznego',
